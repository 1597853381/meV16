...
public class RabbitMQConfig {
    ...
    public Queue initQueue(){
        return new Queue(RabbitMQConstant.ADDORUPDATE_SEARCH_QUEUE, false, false, false);
    }
    /**
     * 将队列绑定到交换机上
     */
    ...
    public TopicExchange initTopicExchange(){
        return new TopicExchange(RabbitMQConstant.BACKGROUND_PRODUCT_EXCHANGE,false,false);
    }
